...
void UBaseCharacterMovementComponent::BeginPlay()
{
	...
	OwnerCharacter = Cast<ABaseCharacter>(CharacterOwner);
...
void UBaseCharacterMovementComponent::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void UBaseCharacterMovementComponent::SetMovementMode(EMovementMode NewMovementMode, uint8 NewCustomMode /*= 0*/)
{
...
ERFMovementMode UBaseCharacterMovementComponent::GetMovementMode()
{
	return RFMovementMode;
}

ERFCustomMovementMode UBaseCharacterMovementComponent::GetCustomMovementMode()
{
...
void UBaseCharacterMovementComponent::MoveSmooth(const FVector& InVelocity, float DeltaTime, FStepDownResult* StepDownResult /*= nullptr*/)
{
...
void UBaseCharacterMovementComponent::PhysWalking(const float DeltaTime, int32 IterationsCount)
{
...
void UBaseCharacterMovementComponent::PhysNavWalking(const float DeltaTime, int32 IterationsCount)
{
	Super::PhysNavWalking(DeltaTime, IterationsCount);
}

void UBaseCharacterMovementComponent::PhysCustom(const float DeltaTime, int32 IterationsCount)
{
	if (DeltaTime < MIN_TICK_TIME)
	{
...
void UBaseCharacterMovementComponent::PhysGrpplingHook(float DeltaTime, int32 IterationCount)
{
...
void UBaseCharacterMovementComponent::PhysClimbing(float DeltaTime, int32 IterationCount)
{
	if (DeltaTime < MIN_TICK_TIME)
	{
		return;
...
FVector UBaseCharacterMovementComponent::GetGrapplingHookMovmentVector()
{
	return GrapplingHookVector;
}

void UBaseCharacterMovementComponent::SetGrapplingHookMovementVector(FVector GrapplingVector)
{
	GrapplingHookVector = GrapplingVector;
}

FVector UBaseCharacterMovementComponent::GetClimbingMovementVector()
{
	return ClimbingVector;
}

void UBaseCharacterMovementComponent::SetClimbingMovementVector(FVector ClimbVector)
{
