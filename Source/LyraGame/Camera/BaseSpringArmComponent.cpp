...
UBaseSpringArmComponent::UBaseSpringArmComponent(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	TargetArmLagMaxTimeStep = 1.f / 60.f;
}

void UBaseSpringArmComponent::OnRegister()
{
...
void UBaseSpringArmComponent::UpdateDesiredArmLocation(bool bDoTrace, bool bDoLocationLag, bool bDoRotationLag, float DeltaTime)
{
