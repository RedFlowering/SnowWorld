...
#include "QAAbility_GrapplingHook.generated.h"

class ABaswCharacter;
class ARopeActor;
class AHookActor;
...
UCLASS(Abstract)
class QUANTUMASCENDRUNTIME_API UQAAbility_GrapplingHook : public ULyraGameplayAbility
{
	GENERATED_BODY()
public:
	UQAAbility_GrapplingHook(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UBaseCharacterMovementComponent> OwnerMovementComponent = nullptr;
