...
#include "QAAbility_Climbing.generated.h"
...
UCLASS(Abstract)
class QUANTUMASCENDRUNTIME_API UQAAbility_Climbing : public ULyraGameplayAbility
{
	GENERATED_BODY()

public:
	UQAAbility_Climbing(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
