...
enum class ECollectionItemType : uint8
{
	...
	Location		UMETA(DisplayName = "Location"),		// 지역/장소
	Character		UMETA(DisplayName = "Character"),		// NPC/캐릭터
	Lore			UMETA(DisplayName = "Lore"),			// 이야기/설정
...
{
	Unknown			UMETA(DisplayName = "Unknown"),			// 미발견
	Seen			UMETA(DisplayName = "Seen"),			// 발견함 (획득은 안함)
	Collected		UMETA(DisplayName = "Collected"),		// 수집함
	MAX				UMETA(Hidden)
};
...
struct FHarmoniaCollectionItem : public FTableRowBase
{
	GENERATED_BODY()
