...
{
	Common			UMETA(DisplayName = "Common"),			// ?ºÎ∞ò
	Uncommon		UMETA(DisplayName = "Uncommon"),		// Í≥†Í∏â
	Rare			UMETA(DisplayName = "Rare"),			// ?¨Í?
	Epic			UMETA(DisplayName = "Epic"),			// ?ÅÏõÖ
	Legendary		UMETA(DisplayName = "Legendary"),		// ?ÑÏÑ§
	Mythic			UMETA(DisplayName = "Mythic"),			// ?†Ìôî
	MAX				UMETA(Hidden)
};
...
{
	Success			UMETA(DisplayName = "Success"),			// ?úÏûë ?±Í≥µ
	Failure			UMETA(DisplayName = "Failure"),			// ?úÏûë ?§Ìå®
	CriticalSuccess	UMETA(DisplayName = "Critical Success"),// ?Ä?±Í≥µ (Ï∂îÍ? Î≥¥ÏÉÅ ??
	Cancelled		UMETA(DisplayName = "Cancelled")		// Ï∑®ÏÜå??
};
...
{
	None			UMETA(DisplayName = "None"),			// ?¥Îîî?úÎÇò ?úÏûë Í∞Ä??(?êÏúºÎ°?
	Anvil			UMETA(DisplayName = "Anvil"),			// ?Ä?•Í∞Ñ Î™®Î£®
	Forge			UMETA(DisplayName = "Forge"),			// ?©Í¥ëÎ°?
	WorkBench		UMETA(DisplayName = "Work Bench"),		// ?ëÏóÖ?Ä
	CookingPot		UMETA(DisplayName = "Cooking Pot"),		// ?îÎ¶¨ ?ÑÎπÑ
	CampFire		UMETA(DisplayName = "Camp Fire"),		// Ï∫†ÌîÑ?åÏù¥??
	AlchemyTable	UMETA(DisplayName = "Alchemy Table"),	// ?∞Í∏à???åÏù¥Î∏?
	SewingTable		UMETA(DisplayName = "Sewing Table"),	// ?¨Î¥â?Ä
	TanningRack		UMETA(DisplayName = "Tanning Rack"),	// Î¨¥ÎëêÏß??†Î∞ò
	Loom			UMETA(DisplayName = "Loom"),			// Î≤†Ì?
	GrindStone		UMETA(DisplayName = "Grind Stone"),		// ?´Îèå
	Enchanting		UMETA(DisplayName = "Enchanting"),		// ÎßàÎ≤ï Î∂Ä?¨Î?
...
{
	Trivial			UMETA(DisplayName = "Trivial"),			// Îß§Ïö∞ ?¨Ï?
	Easy			UMETA(DisplayName = "Easy"),			// ?¨Ï?
	Normal			UMETA(DisplayName = "Normal"),			// Î≥¥ÌÜµ
	Hard			UMETA(DisplayName = "Hard"),			// ?¥Î†§?Ä
	Expert			UMETA(DisplayName = "Expert"),			// ?ÑÎ¨∏Í∞Ä
	Master			UMETA(DisplayName = "Master"),			// ÎßàÏä§??
	Legendary		UMETA(DisplayName = "Legendary"),		// ?ÑÏÑ§
	MAX				UMETA(Hidden)
};
...
enum class EHarmoniaCraftingResult : uint8
{
	...
	CriticalSuccess		UMETA(DisplayName = "Critical Success"),	// ?Ä?±Í≥µ (Ï∂îÍ? Î≥¥ÏÉÅ ??
	Cancelled			UMETA(DisplayName = "Cancelled"),			// Ï∑®ÏÜå??
	InvalidRecipe		UMETA(DisplayName = "Invalid Recipe"),		// ?òÎ™ª???àÏãú??
	InsufficientMaterials	UMETA(DisplayName = "Insufficient Materials"),	// ?¨Î£å Î∂ÄÏ°?
	MAX					UMETA(Hidden)
};
