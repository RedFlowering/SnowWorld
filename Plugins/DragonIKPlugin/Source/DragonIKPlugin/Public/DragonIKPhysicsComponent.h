...
public:	
	...
	UPROPERTY(EditAnywhere,Replicated,BlueprintReadWrite, Category = CoreInput, meta = (DisplayName = "Physanim Handle Holder Reference"))
		TObjectPtr<ADragonIKPhysicsHolder> handler_holder;
...
//		bool modify_physics_states = true;
	...
	*/
	...
	UPROPERTY()
	TObjectPtr<USceneComponent> mesh_parent_reference;
...
public:	
	...
	*/
	...
	UFUNCTION(BlueprintCallable,Server,unreliable,WithValidation, Category = DragonIK, meta = (DisplayName = "-z[Server] DragonIK PhysAnims onHitCallback"))
