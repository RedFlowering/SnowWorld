...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = InputData, meta = (DisplayName = "Physweapon Component Ref", PinHiddenByDefault))
	TObjectPtr<UDragonIKWeaponPhysicsComponent> weapon_handler_component = nullptr;
...
//		FBoneSocketTarget LookAtTarget;
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = InputData, meta = (DisplayName = "Primary Hand Index", PinHiddenByDefault))
	int primary_hand_index = 0;
	...
	int Calibration_Frame_Tick_Count = 0;
...
//	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, meta = (DisplayName = "Interpolation Type"))
	...
	FTransform Frozen_Weapon_Transform = FTransform::Identity;
	FTransform Relative_Frozen_Weapon_Transform = FTransform::Identity;
	FTransform Initial_IK_Hand_Transform;
	FTransform Frozen_Pawn_Transform = FTransform::Identity;
	
	FTransform Frozen_RelMesh_Transform = FTransform::Identity;

	
	FTransform IK_Hand_Real_Offset;
//	FVector IK_Hand_Distance;
