 ...
 */
	 ...
	 * Rotate all feet uniformly through this offset.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, meta = (DisplayName = "Extra Overall Feet Rotation Offset", PinHiddenByDefault))
		FRotator Overall_Feet_Rotation_Offset = FRotator::ZeroRotator;
...
//		FTransform DebugEffectorTransform;
	...
	TArray<TArray<FRotator>> feet_frozen_rotator_array;
...
*/
	...
	*/
	...
	int footstep_listening_counter = 0;

	UPROPERTY()
	TObjectPtr<UDragonIKFootStepsComponent> dragon_footsteps_component = nullptr;
...
*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = StickyFeetFunctions, meta = (PinHiddenByDefault, DisplayName = "Lock Feet Rotation During Stick ?", EditCondition = "sticky_feet_mode"))
	 bool Lock_Feet_Rotation = true;
