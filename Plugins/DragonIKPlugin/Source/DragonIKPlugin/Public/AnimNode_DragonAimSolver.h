...
*/
	...
	*/
	...
	TArray<FBoneReference> Bone_Structure_Initialized = TArray<FBoneReference>();
...
*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = ReachingAndSeparateAim, meta = (DisplayName = "Should arm twist when hand rotates ? (If separate reaching mode)", PinHiddenByDefault))
...
*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = ReachingAndSeparateAim, meta = (DisplayName = "Enable Arm Interpolation ?", PinHiddenByDefault))
		bool Enable_Hand_Interpolation = true;


	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = ReachingAndSeparateAim, meta = (DisplayName = "Arm Interpolation Speed", PinHiddenByDefault))
...
*/
	...
	/*
	 * This is useful if you are trying to rotate your root bone as well as character blueprint in cases like motion matching.
	 * The default aiming angle can be altered using this.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = InterpolationSettings, meta = (DisplayName = "Extra Aiming Rotation Offset", PinHiddenByDefault))
	FRotator Extra_Aiming_Rotation_Offset = FRotator::ZeroRotator;
...
*/
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AdvancedClampingSettings, meta = (DisplayName = "Minimum Aim Frontal Offset (optional)", PinHiddenByDefault))
	 float Aim_Frontal_Offset = 0;
